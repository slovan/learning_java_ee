 ...
 */
public class StudentRestServiceIT {
    private static Client client = ClientBuilder.newClient();

    @Test
    public void shouldNotCreateANullStudent() {
        // POSTs a Null Book
        Response response = client.target("http://localhost:8080/rest-learning/stud/jsonServices/send").request().post(Entity.entity(null, MediaType.APPLICATION_JSON));
